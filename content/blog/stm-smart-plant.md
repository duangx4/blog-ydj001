...
我和队友两个人，从画原理图到写固件，做完了这套系统，最后拿了**优胜奖**。
...
优胜奖不算亮眼，但这块板子是我第一套**完整闭环**的嵌入式系统：有输入（传感器）、有决策（阈值+状态机）、有输出（水泵/灯/屏）、有记忆（历史数据）。后面的路都从它开始。

{{< figure src="award-cert.jpg" alt="新生杯电子设计竞赛获奖证书" caption="2026 年新生杯电子设计竞赛 · 获奖证书" >}}
